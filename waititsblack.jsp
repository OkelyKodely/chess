                                ...
                                if(request.getParameter("username") != null) {
                                    ...
                                    if(rs.next()) {
                                        ...
                                        if(rs2.next()) {
                                            ...
                                            if(rs2.next()) {
                                                String opp = rs2.getString("username");
                                                sql = "select * from chess_game_play where color = 'white' and player = '" + opp + "' and gameid = " + gameid + " order by playid desc;";
                                                out.println(sql);
                                                rs2 = st2.executeQuery(sql);
                                                if(rs2.next()) {
                                                    ...
                                                    out.println("itsu@cks!!");
                                                }
                                            } else {
                                                out.println("asdffsda1234abcd");
                                            }
                                        }
                                    }
                                }
